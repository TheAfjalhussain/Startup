...
• **Communication**: For any questions about these terms, contact us at infogrowthix@gmail.com.
...
const Terms = () => {
  return (
    <section className="section bg-surface">
     <div className="container-px mx-auto max-w-[1480px]">
      ...
      <div className="section-padding pt-0">
        <div className="container-narrow mx-auto">
          ...
          >
            ...
            <a 
              href="mailto:infogrowthix@gmail.com" 
              className="text-primary hover:text-primary/80 font-medium transition-colors"
            >
              infogrowthix@gmail.com
            </a>
          </motion.div>
        </div>
      </div>
